...
const Skills = () => {
  return (
    <Section>
      <SkillsWrapper>
        <h1 className="skills-banner">Skills</h1>
        <div className="skill-wrapper">
          ...
          <div className="skill">
            ...
            <img className="skill-image" src={require("../../images/vscode.png")} alt="html/css logo" />
          </div>
          <div className="skill">
            <h2 className="skill-title">Linux Shell</h2>
            <img className="skill-image" src={require("../../images/bash.png")} alt="html/css logo" />
          </div>
        </div>
      </SkillsWrapper>
    </Section>
